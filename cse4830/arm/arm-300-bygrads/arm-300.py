...
def main(argv):
    ...
    good_strings = [b'Good', b'good',  b'Succ', b'succ', b'ongrat', b'orrect', b'No', b'sry']
    ...
    #good_address = proj.loader.find_symbol('display_flag').rebased_addr
    #bad_address =
    ...
    if sim.found:
        ...
        for solve in sim.found:
            print(solve.posix.dumps(sys.stdin.fileno()))
